...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.exchange_sync_runs TO anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.audit_logs TO anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.normalized_assets TO anon, authenticated;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.va_positions TO anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.va_connections TO anon, authenticated;
