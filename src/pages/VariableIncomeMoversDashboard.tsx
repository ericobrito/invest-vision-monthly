...
const avenueKnownPositions: Record<string, {
  ...
  "TSLA": { name: "Tesla Inc", quantity: 14.082900, averagePrice: 319.69, currentPrice: 380.12, currentValueUSD: 5353.19, currentValueBRL: 27473.65, appliedAmountBRL: 23106.09, profitPct: 18.90 },
  "META": { name: "Meta Platforms", quantity: 2.969900, averagePrice: 210.52, currentPrice: 744.10, currentValueUSD: 2209.90, currentValueBRL: 11341.66, appliedAmountBRL: 3208.75, profitPct: 253.46 },
  "USDT": { name: "Tether USDt USD", quantity: 1542.910000, averagePrice: 1.00, currentPrice: 1.00, currentValueUSD: 1542.72, currentValueBRL: 7917.57, appliedAmountBRL: 7917.57, profitPct: 0.00 },
  "BRK-B": { name: "Berkshire Hathaway", quantity: 2.597600, averagePrice: 229.16, currentPrice: 507.17, currentValueUSD: 1317.42, currentValueBRL: 6761.29, appliedAmountBRL: 3055.04, profitPct: 121.32 },
  "GOOGL": { name: "Alphabet Inc (Google)", quantity: 2.958000, averagePrice: 94.84, currentPrice: 337.83, currentValueUSD: 999.30, currentValueBRL: 5128.61, appliedAmountBRL: 1439.79, profitPct: 256.21 },
  "IONQ": { name: "IonQ Inc", quantity: 5.082210, averagePrice: 66.90, currentPrice: 42.54, currentValueUSD: 216.20, currentValueBRL: 1109.57, appliedAmountBRL: 1744.95, profitPct: -36.41 },
  "RGTI": { name: "Rigetti Computing", quantity: 8.000000, averagePrice: 48.87, currentPrice: 16.01, currentValueUSD: 128.04, currentValueBRL: 657.13, appliedAmountBRL: 2006.48, profitPct: -67.25 },
  "AMD": { name: "Advanced Micro Devices", quantity: 0.194700, averagePrice: 196.89, currentPrice: 614.61, currentValueUSD: 119.66, currentValueBRL: 614.14, appliedAmountBRL: 196.72, profitPct: 212.16 },
};
  ...
  const consolidatedAssets = useMemo(() => {
    ...
    Object.entries(cryptoCanonical).forEach(([ticker, c]) => {
      map.set(ticker, {
        ...
        profitBRL: c.currentValueBRL - c.appliedAmountBRL,
        profitPct: c.profitPct,
        currentPriceUSD: c.currentPriceUSD,
