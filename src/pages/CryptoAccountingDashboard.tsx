...
export function CryptoAccountingDashboard() {
  ...
  const [isGcapModalOpen, setIsGcapModalOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-2">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => setIsGcapModalOpen(true)}
              className="border-primary/50 text-primary hover:bg-primary/10 font-semibold"
            >
              <FileSpreadsheet className="w-4 h-4 mr-1 text-primary" /> Guia GCAP & IRPF
            </Button>
            <Link to="/">
      ...
      <main className="container max-w-7xl mx-auto px-4 py-6 space-y-6">
              ...
              <CardContent className="space-y-4 text-xs">
                ...
                <div className="p-3 bg-muted/30 rounded-lg space-y-2 border border-border/50">
                  ...
                  <div className="pt-2 flex justify-end">
                    ...
                    >
                      <FileSpreadsheet className="w-3.5 h-3.5 mr-1" /> Ver Passo a Passo GCAP & IR Completo
                    </Button>
                  </div>
                </div>
              </CardContent>
        ...
        {/* GCAP & IRPF Modal Dialog */}
        <Dialog open={isGcapModalOpen} onOpenChange={setIsGcapModalOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-lg">
                <FileSpreadsheet className="w-5 h-5 text-primary" /> Guia Oficial do GCAP & Imposto de Renda (Receita Federal)
              </DialogTitle>
              <DialogDescription>
                Instruções passo a passo para declaração de criptoativos isentos e tributáveis
              </DialogDescription>
            </DialogHeader>
            <div className="pt-2">
              <GCAPGuideCard />
