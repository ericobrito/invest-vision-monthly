    ...
    .map((inv: any): Investment => {
      ...
      if ((!positions || positions.length === 0) && (mode === 'DETAILED' || mode === 'CONNECTED')) {
        if (nameLower.includes("coinbase")) {
          ...
          const effectiveFx = fxRates["USD"] || 5.1322;
          ...
          positions = [
            {
              ...
              currentPrice: 1.00,
              appliedAmount: 0.00,
              currentValue: 1542.76,
              currentValueBRL: 1542.76 * 5.1322,
              appliedAmountBRL: 0.00,
              currency: "USD",
              fxRate: 5.1322,
            },
            {
              ...
              currentValue: 1319.92,
              currentValueBRL: 1319.92 * effectiveFx,
              appliedAmountBRL: 595.27 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
            {
              ...
              currentValue: 121.44,
              currentValueBRL: 121.44 * effectiveFx,
              appliedAmountBRL: 390.96 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
            {
              ...
              averagePrice: 94.84,
              currentPrice: 342.48,
              appliedAmount: 390.55,
              currentValue: 1410.33,
              currentValueBRL: 1410.33 * effectiveFx,
              appliedAmountBRL: 390.55 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
            {
              ...
              currentValue: 5300.31,
              currentValueBRL: 5300.31 * effectiveFx,
              appliedAmountBRL: 4502.18 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
            {
              ...
              averagePrice: 210.52,
              currentPrice: 610.68,
              appliedAmount: 1004.16,
              currentValue: 2912.88,
              currentValueBRL: 2912.88 * effectiveFx,
              appliedAmountBRL: 1004.16 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
            {
              ...
              averagePrice: 196.89,
              currentPrice: 456.16,
              appliedAmount: 230.26,
              currentValue: 533.47,
              currentValueBRL: 533.47 * effectiveFx,
              appliedAmountBRL: 230.26 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
            {
              ...
              currentValue: 198.31,
              currentValueBRL: 198.31 * effectiveFx,
              appliedAmountBRL: 340.00 * 5.0740,
              currency: "USD",
              fxRate: effectiveFx,
            },
          ];
