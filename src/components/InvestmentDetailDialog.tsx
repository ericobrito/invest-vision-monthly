...
const InvestmentDetailDialog = ({ open, onOpenChange, investment }: Props) => {
  ...
  if (effectivePositions.length === 0 && (mode === "CONNECTED" || nameLower.includes("binance") || nameLower.includes("bybit") || nameLower.includes("coinbase") || nameLower.includes("avenue"))) {
